...
private fun part1(map: Map<String, List<String>>): Int {
    return addOrbits(map, "COM", 1)
}

private fun part2(map: Map<String, List<String>>): Int {
...
fun addOrbits(map: Map<String, List<String>>, objectName: String, depth: Int): Int {
